...
export default function Search() {
  ...
  return(
    <>
      ...
      <form className="absolute container top-1 mx-0 min-w-full flex flex-col items-center">
            
        <input className="absolute animate-appear text-center outline-none bg-gray-100 border-gray-300 focus:outline-none rounded-md w-80 h-12 text-lg" autoFocus id="searchInput" ref={inputRef} onBlur={handleBlur} type="text" placeholder="Search"></input>
